(() => {
  ...
  // .wrangler/tmp/bundle-cPMeYn/middleware-insertion-facade.js
  __facade_registerInternal__([middleware_ensure_req_body_drained_default, middleware_miniflare3_json_error_default]);

  // src/index.js
  var CALENDAR_ID = "Zmx1a2VnYW1pbmc1N0BnbWFpbC5jb20@group.calendar.google.com";
  var CACHE_TTL = 300;
  ...
  async function handleRequest(request) {
    ...
    try {
      const apiKey = GCALENDAR_API_KEY;
